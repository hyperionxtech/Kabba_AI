This code implements **multi-layer Recurrent Neural Network** (RNN, LSTM, and GRU) for training/sampling from character-level language models.5/05/21/rnn-effectiveness/).
...
All input data is stored inside the `data/` directory.
